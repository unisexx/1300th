<h3>ประเภทการสูญเสียอวัยวะ</h3>
<div id="search">
<div id="searchBox">
<form class="form-inline">
  <div class="col-xs-4">
    <input type="text" class="form-control " id="exampleInputName2" placeholder="ชื่อประเภทการสูญเสียอวัยวะ">
  </div>
...
<div id="btnBox">
  <input type="button" title="เพิ่มประเภทการสูญเสียอวัยวะ" value="เพิ่มประเภทการสูญเสียอวัยวะ" onclick="document.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'" class="btn btn-warning vtip" />
</div>
...
<tr>
  ...
  <th align="left">ชื่อประเภทการสูญเสียอวัยวะ</th>
...
<tr class="odd">
  <td>2</td>
  <td>การได้ยินหรือสิ่อความหมาย</td>
  <td><img src="images/icon_checkbox.png" width="24" height="24" /></td>
...
<tr>
  <td>3</td>
  <td>การเคลื่อนไหวหรือทางร่างกาย</td>
  <td><img src="images/icon_checkbox.png" width="24" height="24" /></td>
  <td><img src="images/edit.png" width="24" height="24" style="margin-right:10px;" class="vtip" title="แก้ไขรายการนี้" /> <img src="images/remove.png" width="32" height="32" class="vtip" title="ลบรายการนี้"  /></td>
  </tr>
<tr class="odd">
  <td>4</td>
  <td align="left">ทางจิตใจหรือพฤติกรรม</td>
  <td><img src="images/icon_checkbox.png" width="24" height="24" /></td>
  <td><img src="images/edit.png" width="24" height="24" style="margin-right:10px;" class="vtip" title="แก้ไขรายการนี้" /> <img src="images/remove.png" width="32" height="32" class="vtip" title="ลบรายการนี้"  /></td>
  </tr>
<tr>
