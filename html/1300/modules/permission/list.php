...
<div id="btnBox">
  <input type="button" title="เพิ่มสิทธิ์การใช้งาน" value="เพิ่มสิทธิ์การใช้งาน" onclick="document.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'" class="btn btn-warning vtip" />
</div>
