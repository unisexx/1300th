...
<form class="form-inline">
 <input type="text" class="form-control " id="exampleInputName2" placeholder="ชื่อระดับความเร่งด่วน" style="width:350px;">
 <button type="submit" class="btn btn-info"><img src="images/search.png" width="16" height="16" />ค้นหา</button>
</form>
</div>
</div>
<div id="btnBox">
  <input type="button" title="เพิ่มระดับความเร่งด่วน" value="เพิ่มระดับความเร่งด่วน" onclick="document.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'" class="btn btn-success vtip" />
</div>
