...
<div id="btnBox">
  <input type="button" title="เพิ่มจังหวัด/รัฐ" value="เพิ่มจังหวัด/รัฐ" onclick="document.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'" class="btn btn-success vtip" />
</div>
