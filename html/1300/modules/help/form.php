...
<tr>
  ...
  <td>
    <input type="text" class="form-control" id="exampleInputName" placeholder="ชื่อแนวทางการช่วยเหลือฯ" style="width:350px;" />
    </td>
</tr>
<tr>
  <th>แบบมีระบุ</th>
  <td><input name="checkbox2" type="checkbox" id="checkbox2" />
    textbox</td>
</tr>
<tr>
