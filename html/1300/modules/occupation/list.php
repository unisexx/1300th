...
<form class="form-inline">
  <div class="col-xs-4">
    <input type="text" class="form-control " id="exampleInputName2" placeholder="ชื่ออาชีพ">
  </div>
...
<div id="btnBox">
  <input type="button" title="เพิ่มอาชีพ" value="เพิ่มอาชีพ" onclick="document.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'" class="btn btn-warning vtip" />
</div>
