...
<input type="text" class="form-control numOnly"  style="width:70px;" maxlength="3"> <label style="width:20px;">ปี</label>
</div>
...
<input type="text" class="form-control numOnly"  style="width:50px;" maxlength="2">
...
<div class="form-group form-inline col-md-4">
<label>รวมบุตร</label>
<input type="text" class="form-control numOnly"  style="width:50px;" maxlength="2" readonly="readonly">
<label style="width:30px;">คน</label>
</div>
...
<textarea class="form-control"  placeholder="" style="width:80%; height:80px;"></textarea>
</div>
